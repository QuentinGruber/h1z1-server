...
export interface CharacterEffectPackage {
  unknownQword1?: string;
  unknownQword2?: string;
  unknownBoolean1?: boolean;
  unknownData1 :{
...
export interface CharacterSetSpawnAnimation {
  characterId: string;
  unknownQword2?: string;
  unknownBool1?: boolean;
  unknownFloat1?: number;
...
export interface GroupCreateGroup {
  unknownDword1?: number;
  joinData :{
  inviteData :{
  characterId?: string;
...
export interface LoadoutSetCurrentLoadoutSlot {
  characterId?: string;
...
export interface AcquireTimers {
  unknownDword1?: number;
  unknownArray1?: unknown[];
  unknownArray2?: unknown[];
  unknownByte1?: number;
...
export interface CharacterStateTimerDataSource {
  characterId?: string;
  interactionData :{
  timeData :{
  duration?: number;
...
export interface CharacterStateUpdateTimerDataSource {
  characterId?: string;
  interactionData :{
  timeData :{
  duration?: number;
...
export interface BroadcastLocal {
  identity :{
  unknownDword1?: number;
  unknownDword2?: number;
  unknownDword3?: number;
...
export interface BroadcastZone {
  identity :{
  unknownDword1?: number;
  unknownDword2?: number;
  unknownDword3?: number;
