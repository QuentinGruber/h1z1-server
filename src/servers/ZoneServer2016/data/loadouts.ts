...
export const characterBuildKitLoadout = [
  ...
  { item: Items.SHELTER, count: 50 },
  { item: Items.SHELTER_LARGE, count: 50 },
  { item: Items.SHELTER_UPPER, count: 50 },
  { item: Items.SHELTER_UPPER_LARGE, count: 50 },
  { item: Items.DOOR_METAL, count: 50 },
  { item: Items.DOOR_WOOD, count: 50 },
  ...
  { item: Items.METAL_GATE, count: 50 },
  { item: Items.METAL_WALL, count: 50 },
  { item: Items.METAL_WALL_UPPER, count: 50 },
