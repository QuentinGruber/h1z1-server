...
######If that case, there maybe a Communicator to be a bridge between Client side and Server side.
## Communicator
...
######So I just need to thinking about App layer of the Communicator .
