...
const dev: any = {
  ...
  airdrop: function (
    ...
    server.sendData(client, "Command.DeliveryDisplayInfo", {
      unknownDword1: 1,
      unknownArray1: [
        {
          unknownDword1: 1,
          unknownDword2: ModelIds.AIRDROP_PLANE,
          unknownDword3: ModelIds.AIRDROP_PLANE,
          unknownDword4: 3508941303,
          unknownDword5: 75,
          //unknownDword5: 0.5,
          position: [0, 0, 0, 0],
          unknownDword6: 0,
          unknownArray1: [
            {
              progress: 0,
              position: [-3792.851, 950, -6396, 0]
            },
            {
              progress: 0.5859599,
              position: [155.8877, 400, -577.9485, 0]
            },
            {
              progress: 0.6926265,
        ...
        {
          unknownDword1: 2,
          unknownDword2: ModelIds.MILITARY_CRATE_PARACHUTE,
          unknownDword3: ModelIds.MILITARY_CRATE_PARACHUTE,
          unknownDword4: 3508995749,
          unknownDword5: 28.64041,
          //unknownDword5: 0,
          position: [1100.13, 27.67558, 811.8412, 1],
          unknownDword6: 0,
          unknownArray1: [
            {
              progress: 0,
        ...
        {
          unknownDword1: 3,
          unknownDword2: ModelIds.AIRDROP_CARGO_CONTAINER,
          unknownDword3: ModelIds.AIRDROP_CARGO_CONTAINER,
          unknownDword4: 3508995749,
          unknownDword5: 31.23798,
          //unknownDword5: 0,
          position: [1100.13, 27.67558, 811.8412, 1],
          unknownDword6: 0,
          unknownArray1: [
        ...
        {
          unknownDword1: 4,
          unknownDword2: ModelIds.MILITARY_CRATE,
          unknownDword3: ModelIds.MILITARY_CRATE,
          unknownDword4: 3508995749,
          unknownDword5: 28.64041,
          //unknownDword5: 0,
          position: [1100.13, 27.67558, 811.8412, 1],
  ...
  plane(server: ZoneServer2016, client: Client, args: Array<string>) {
    const planeId = server.generateGuid(),
      pos = new Float32Array([
        client.character.state.position[0],
        client.character.state.position[1] + 500,
        client.character.state.position[2],
        client.character.state.position[3]
      ]),
      vehicle = new Vehicle2016(
        planeId,
        server.getTransientId(planeId),
        9215,
        pos,
  ...
  mvplane(server: ZoneServer2016, client: Client, args: Array<string>) {
    Object.values(server._npcs)
      .filter((ve) => ve.actorModelId == ModelIds.AIRDROP_PLANE)
      .forEach((vehicle) => {
        vehicle.state.position[0] += 1;
        ...
        server.sendAlert(client, "Plane should've moved");
      });
  },
