        ...
        for (const a in server._constructionFoundations) {
            ...
            if (Object.keys(foundation.occupiedWallSlots).length == 0 &&
                ...
                if (foundation.objectLessTicks >= foundation.objectLessMaxTicks) {
                    ...
                    Object.values(foundation.freeplaceEntities).forEach((entity: LootableConstructionEntity | ConstructionDoor | ConstructionChildEntity) => {
