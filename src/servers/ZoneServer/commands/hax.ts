...
const hax: any = {
  ...
  itemdefinition: function (server: ZoneServer, client: Client, args: any[]) {
        ...
        itemDefinitions: [
          {
            definitionData: {
              ...
              unknownDword8: 10,
              unknownDword9: 11,
              coinPurchasePrice: 12,
              itemClass: 13,
              slot: 14,
              unknownDword13: 15,
              modelName: "Weapon_M16A4.adr",
              textureAlias: "",
              genderUsage: 16,
              itemType: 17,
              categoryId: 18,
              unknownDword17: 19,
              compositeEffectId: 20,
              powerRating: 21,
              minProfileRank: 22,
              unknownDword21: 23,
              unknownDword22: 24,
