...
var chancePumpShotgun = 50;
var chanceAR15 = 50;
var chanceTools = 50;
var chance1911 = 100;
var chanceM24 = 50;
var chanceConsumables = 50;
var chanceClothes = 50;
var chanceResidential = 10;
var chanceRare = 10;
var chanceIndustrial = 10;
var chanceWorld = 10;
var chanceLog = 10;
    ...
    Z1_npcs.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => {
		  ...
		  if (spawnchance <=40) { // temporary spawnchance
          createEntity(
            authorizedModelId[
    ...
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  ...
		  if (chance <=chanceAR15) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
...
function  createPumpShotgun() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chancePumpShotgun) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
...
function  createTools() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceTools) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
...
function  create1911() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chance1911) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
...
function  createM24() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceM24) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
  ...
  function createConsumables() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceConsumables) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
  ...
  function createClothes() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceClothes) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
  ...
  function createResidential() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceResidential) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
  ...
  function createRare() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceRare) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
  ...
  function createIndustrial() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceIndustrial) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
  ...
  function createWorld() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceWorld) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
  ...
  function createLog() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceLog) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
  ...
  function createCommercial() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceCommercial) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
  ...
  function createFarm() {
    Z1_items.forEach((spawnerType: any) => {
      ...
      if (authorizedModelId.length) {
        spawnerType.instances.forEach((itemInstance: any) => { 
		  const chance = Math.floor(Math.random() * 100) + 1 // temporary spawnchance
		  if (chance <= chanceFarm) { // temporary spawnchance
          createEntity(
            authorizedModelId[
              Math.floor(Math.random() * authorizedModelId.length)
            ],
