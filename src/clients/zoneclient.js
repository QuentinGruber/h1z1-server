...
var EventEmitter = require("events").EventEmitter,
  ...
  fs = require("fs"),
  util = require("util"),
  ZoneProtocol = require("../protocols/zoneprotocol").ZoneProtocol,
  ZonePackets = require("../protocols/zoneprotocol").ZonePackets,
...
function ZoneClient(
  ...
  var gatewayClient = (this._gatewayClient = new GatewayClient(
    serverAddress,
    serverPort,
    key,
    localPort
    ...
    if (packet) {
      ...
      switch (packet.name) {
        ...
        case "SendSelfToClient":
          ...
          gatewayClient.sendTunnelData(
            protocol.pack("GetContinentBattleInfo"),
            1
          );
