            ...
            fields: [
                { 
                    ...
                    fields: [
                        ...
                        { name: "unknownWord1", type: "uint16", defaultValue: 32767 },
                        { name: "unknownWord2", type: "uint16", defaultValue: 1 },
                        { name: "unknownDword1", type: "uint32", defaultValue: 16909060 },
        ...
        0x094700, 
        {
            fields: [
                { 
                    ...
                    type: "byteswithlength", 
                    fields: [
                        { name: "itemDefinitionsLength", type: "uint32", defaultValue: 1 },
                        {
    ...
    [
        ...
        0x9504,
        {
            fields: [
                    { name: "characterData", type: "schema", fields: equipmentCharacterDataSchema },
                    { name: "gameTime", type: "uint32", defaultValue: 0 },
                    { name: "slotsArrayLength", type: "uint32", defaultValue: 1 },
                    {
                        name: "slots",
                        type: "array",
                        defaultValue: [{}],
                    ...
                    { name: "unknownString1", type: "string", defaultValue: "string1" },
                    { name: "unknownString2", type: "string", defaultValue: "string2" },
                    { name: "equipmentTexturesArrayLength", type: "uint32", defaultValue: 1 },
                    {
                    ...
                    { name: "equipmentModelsArrayLength", type: "uint32", defaultValue: 1 },
                    {
