...
export const profileSchema = [
  ...
  { name: "descriptionId", type: "uint32", defaultValue: 1 },
  { name: "type", type: "uint8", defaultValue: 1 },
  { name: "unknownDword1", type: "uint32", defaultValue: 1 },
  { name: "abilityBgImageSet", type: "uint32", defaultValue: 1 },
  { name: "badgeImageSet", type: "uint32", defaultValue: 1 },
  { name: "buttonImageSet", type: "uint32", defaultValue: 1 },
