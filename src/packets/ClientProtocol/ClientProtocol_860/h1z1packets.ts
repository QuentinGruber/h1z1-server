...
const EquippedContainersSchema = {
  ...
  fields: [
    ...
    { name: "unknownQword1", type: "int64string", defaultValue: "0" },
    { name: "unknownDword2", type: "uint32", defaultValue: 0 },
    { name: "unknownQword2", type: "int64string", defaultValue: "0" },
    { name: "unknownDword3", type: "uint32", defaultValue: 0 },
    {
      name: "unknownArray1",
      type: "array8",
...
const lightWeightPcSchema = [
  { name: "characterId", type: "int64string", defaultValue: "0" },
  {
    name: "transientId",
    type: "custom",
  ...
  { name: "unknownFloat1", type: "float", defaultValue: 0.0 },
  { name: "unknownGuid1", type: "int64string", defaultValue: "0" },
  { name: "unknownDword6", type: "uint32", defaultValue: 0 },
  { name: "unknownDword7", type: "uint32", defaultValue: 0 },
  { name: "unknownByte4", type: "uint8", defaultValue: 0 },
  { name: "unknownDword8", type: "uint32", defaultValue: 0 },
  { name: "unknownDword9", type: "uint32", defaultValue: 0 },
  { name: "unknownGuid2", type: "int64string", defaultValue: "0x0000" },
...
const lightWeightNpcSchema = [
  ...
  { name: "characterId", type: "int64string", defaultValue: "0x0000000000000000" },
  {
    name: "transientId",
    type: "custom",
    parser: readUnsignedIntWith2bitLengthValue,
  ...
  { name: "unknown32", type: "int64string", defaultValue: "0x0000000000000000" },
  {
    name: "attachedObject",
    type: "schema",
    fields: [
  ...
  { name: "unknown36", type: "int64string", defaultValue: "0x0000000000000000" },
...
const itemBaseSchema = [
  { name: "itemId", type: "uint32", defaultValue: 0 },
  { name: "unknownDword2", type: "uint32", defaultValue: 0 },
  { name: "unknownGuid1", type: "int64string", defaultValue: "0x0000000000000000" },
  { name: "unknownDword3", type: "uint32", defaultValue: 0 },
  { name: "unknownDword4", type: "uint32", defaultValue: 0 },
  { name: "unknownDword5", type: "uint32", defaultValue: 0 },
  { name: "unknownQword6", type: "int64string", defaultValue: "0x0000000000000000" }, // ici
  { name: "unknownDword7", type: "uint32", defaultValue: 0 },
  { name: "unknownDword8", type: "uint32", defaultValue: 0 },
  { name: "unknownDword9", type: "uint32", defaultValue: 0 },
  { name: "unknownDword10", type: "uint32", defaultValue: 0 },
  { name: "unknownDword11", type: "uint32", defaultValue: 0 },
  { name: "unknownByte1", type: "uint8", defaultValue: 0 },
  { name: "unknownQword7", type: "int64string", defaultValue: "0x0000000000000000" },
];
...
const effectTagDataSchema = [
...

  {
    ...
    fields: [
      { name: "unknownGuid1", type: "int64string", defaultValue: "0" },
      { name: "unknownGuid2", type: "int64string", defaultValue: "0" },
    ],
  },
...
const weaponPackets = [
  [
    ...
    {
      fields: [
        { name: "guid", type: "int64string", defaultValue: "0" },
        { name: "unknownByte1", type: "uint8", defaultValue: 0 },
        { name: "unknownByte2", type: "uint8", defaultValue: 0 },
      ],
    },
  ...
  [
    ...
    0x8207,
    {
      fields: [{ name: "guid", type: "int64string", defaultValue: "0" }],
    },
  ],
...
const resourceEventDataSubSchema = [
  ...
  { name: "unknownByte2", type: "uint8", defaultValue: 0 },
  // end of this loop
  { name: "unknownTime1", type: "int64string", defaultValue: "0" },
  { name: "unknownTime2", type: "int64string", defaultValue: "0" },
  { name: "unknownTime3", type: "int64string", defaultValue: "0" },
  { name: "unknownTime4", type: "int64string", defaultValue: "0" },
];
...
const rewardBundleDataSchema = [
  ...
  { name: "unknownDword5", type: "uint32", defaultValue: 0 },
  { name: "unknownDword6", type: "uint32", defaultValue: 0 },
  { name: "time", type: "int64string", defaultValue: "0" },
  { name: "characterId", type: "int64string", defaultValue: "0" },
  { name: "nameId", type: "uint32", defaultValue: 0 },
  { name: "unknownDword8", type: "uint32", defaultValue: 0 },
  { name: "imageSetId", type: "uint32", defaultValue: 0 },
...
const achievementDataSchema = [
  ...
  { name: "nameId", type: "uint32", defaultValue: 0 },
  { name: "descriptionId", type: "uint32", defaultValue: 0 },
  { name: "timeStarted", type: "int64string", defaultValue: "0" },
  { name: "timeFinished", type: "int64string", defaultValue: "0" },
...
const fullPcDataSchema = [
...

  {
    ...
    fields: [
      ...
      { name: "unknownQword1", type: "int64string", defaultValue: "0" },
      { name: "unknownQword2", type: "int64string", defaultValue: "0" },
      { name: "unknownQword3", type: "int64string", defaultValue: "0" },
      { name: "unknownGuid1", type: "int64string", defaultValue: "0" },
      { name: "unknownDword11", type: "uint32", defaultValue: 0 },
      { name: "unknownDword12", type: "uint32", defaultValue: 0 },
      { name: "unknownDword13", type: "uint32", defaultValue: 0 },
      ...
      { name: "unknownGuid3", type: "int64string", defaultValue: "0" },
      { name: "unknownGuid4", type: "int64string", defaultValue: "0" },
      { name: "unknownDword22", type: "uint32", defaultValue: 0 },
      { name: "unknownQword4", type: "int64string", defaultValue: "0" },
...
const fullNpcDataSchema = [
  ...
  { name: "unknownDword12", type: "uint32", defaultValue: 0 },
  { name: "unknownDword13", type: "uint32", defaultValue: 0 },
  { name: "unknownGuid", type: "int64string", defaultValue: "0" },
  { name: "unknownFloat3", type: "float", defaultValue: 0.0 },
...
var packets = [
      ...
      fields: [
        {
          ...
          fields: [
            ...
            { name: "lastLoginDate", type: "int64string", defaultValue: 0 },
            ...
            { name: "unknownDword14", type: "uint32", defaultValue: 0 },
            currencySchema,
            { name: "creationDate", type: "int64string", defaultValue: 0 },
            { name: "unknownDword15", type: "uint32", defaultValue: 0 },
            { name: "unknownDword16", type: "uint32", defaultValue: 0 },
            { name: "unknownBoolean1", type: "boolean", defaultValue: true },
            ...
            },
            {
              ...
              fields: [
                ...
                { name: "name", type: "string", defaultValue: "" },
                { name: "type", type: "uint32", defaultValue: 0 },
                { name: "elapsedTime", type: "int64string", defaultValue: 0 },
                {
                  name: "online",
                  type: "boolean",
                  defaultValue: true,
              ...
              fields: [
                ...
                { name: "filterType", type: "uint32", defaultValue: 0 },
                {
                  ...
                  fields: [
                    ...
                    { name: "unknownDword4", type: "uint32", defaultValue: 0 },
                    { name: "unknownDword5", type: "uint32", defaultValue: 0 },
                    { name: "numberOfItems", type: "int64string", defaultValue: 0 },
                    { name: "unknownDword6", type: "uint32", defaultValue: 0 },
                    { name: "unknownDword7", type: "uint32", defaultValue: 0 },
            ...
            },*/
            {
              ...
              type: "schema",
              fields: [
                { name: "skillPointsGranted", type: "int64string", defaultValue: 0 },
                { name: "skillPointsTotal", type: "int64string", defaultValue: 0 },
                { name: "skillPointsSpent", type: "int64string", defaultValue: 0 },
  ...
  [
    ...
    0x060100,
    {
      fields: [
        ...
        { name: "characterId1", type: "int64string", defaultValue: "0" },
        { name: "characterId2", type: "int64string", defaultValue: "0" },
  ...
  [
    ...
    0x091e00,
    {
      fields: [
        ...
        { name: "vehicleId", type: "int64string", defaultValue: "0x0000" },
      ],
    },
  ],
  ...
  [
    ...
    0x094900,
    {
      fields: [{ name: "characterId", type: "int64string", defaultValue: "0" }],
    },
  ],
  ...
  [
    ...
    {
      fields: [
        { name: "unk1", type: "byte", defaultValue: 0 },
  ...
  [
    ...
    0x0f0c,
    {
      fields: [
        { name: "characterId", type: "int64string", defaultValue: "0" },
        { name: "targetCharacterId", type: "int64string", defaultValue: "0" },
      ],
    },
  ],
  ...
  [
    ...
    0x0f38,
    {
      fields: [
        { name: "respawnType", type: "uint8", defaultValue: 0 },
        { name: "respawnGuid", type: "int64string", defaultValue: "0" },
        { name: "profileId", type: "uint32", defaultValue: 0 },
      ],
    },
  ],
  ...
  [
    ...
    0x0f48,
    {
      fields: [
        { name: "guid", type: "int64string", defaultValue: "0" },
        { name: "guid2", type: "int64string", defaultValue: "0" },
        { name: "characterId", type: "int64string", defaultValue: "0" },
      ],
    },
  ],
  ...
  [
    ...
    0x0f4d,
    {
      fields: [
        ...
        { name: "unk3", type: "int64string", defaultValue: "0" },
      ],
    },
  ],
  [
  ...
  [
    ...
    {
      fields: [
        { name: "guid1", type: "int64string", defaultValue: "0" },
        { name: "guid2", type: "int64string", defaultValue: "0" },
        { name: "guid3", type: "int64string", defaultValue: "0" },
        { name: "guid4", type: "int64string", defaultValue: "0" },
        { name: "gameTime", type: "uint32", defaultValue: 0 },
      ],
    },
  ],
  ...
  [
    ...
    0x2d08,
    {
      fields: [
        ...
        { name: "messageTime", type: "int64string", defaultValue: "0" },
        {
          name: "messageData1",
          type: "schema",
          fields: [
  ...
  [
    ...
    {
      fields: [
        { name: "time1", type: "int64string", defaultValue: "0" },
        { name: "time2", type: "int64string", defaultValue: "0" },
        { name: "clientTime", type: "int64string", defaultValue: "0" },
        { name: "serverTime", type: "int64string", defaultValue: "0" },
        { name: "serverTime2", type: "int64string", defaultValue: "0" },
        { name: "time3", type: "int64string", defaultValue: "0" },
      ],
    },
  ],
  [
        ...
        { name: "gameTime", type: "uint32", defaultValue: 0 },
        {
          ...
          types: {
            ...
            2: [
              ...
              { name: "unknownGuid3", type: "int64string", defaultValue: "0" },
              { name: "unknownGuid4", type: "int64string", defaultValue: "0" },
              { name: "unknownGuid5", type: "int64string", defaultValue: "0" },
            ],
            3: [
