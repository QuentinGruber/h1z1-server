      ...
      fields: [
        ...
        { name: "canBypassServerLock", type: "boolean" },
        {
          ...
          fields: [
            { name: "characterId", type: "int64string" },
            { name: "serverId", type: "uint32" },
            { name: "lastLoginDate", type: "int64string",  defaultValue:"0x0000000000000001"},
            ...
            { name: "status", type: "uint32", defaultValue:1 },
            {
              ...
              fields: [
                ...
                { name: "nextBattleRankPercent", type: "uint32", defaultValue:1 },
                ...
                { name: "lastUseDate", type: "int64string",  defaultValue:"0x0000000000000001" },
              ],
            },
          ],
        },
