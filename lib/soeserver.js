"use strict";
var EventEmitter = require("events").EventEmitter, SOEProtocol = require("./soeprotocol").SOEProtocol, SOEPackets = require("./soeprotocol").SOEPackets, SOEInputStream = require("./soeinputstream").SOEInputStream, SOEOutputStream = require("./soeoutputstream").SOEOutputStream, util = require("util"), fs = require("fs"), dgram = require("dgram"), debug = require("debug")("SOEServer");
    ...
    connection.on("message", function (data, remote) {
        ...
        if (result !== undefined && result !== null) {
            if (know_client &&
                ...
                delete clients[client.address];
                debug("Delete an old session badly closed by the client(" +
                    client.address +
                    ":" +
                    client.port +
                    ")");
...
SOEServer.prototype.deleteClient = function (client) {
    this === null || this === void 0 ? true : delete this._clients[client.address];
