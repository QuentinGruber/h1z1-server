...
var SOEClient = require("./soeclient").SOEClient, https = require("https"), util = require("util"), LoginProtocol = require("./loginprotocol").LoginProtocol, loginProtocolName = "LoginUdp_9", debug = require("debug")("LoginClient");
var LoginClient = /** @class */ (function (_super) {
    ...
    LoginClient.prototype.login = function (fingerprint) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, SetupLoginRequest(fingerprint, this._soeClient._sessionId.toString(), this._soeClient._protocol)];
                    case 1:
                        data = _a.sent();
