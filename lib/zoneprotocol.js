...
function parseWeaponDefinitionReferenceData(data) {
    ...
    var schema = [
        { name: "weaponDefinitions",     type: "array", fields: [
            ...
            { name: "ammoSlots",                    type: "array", fields: [
        ...
        { name: "fireGroups",     type: "array", fields: [
        ...
        { name: "fireModes",     type: "array", fields: [
...
ZoneProtocol.prototype.parse = function(data, flags, fromClient, referenceData) {
    ...
    if (packet) {
        if (packet.schema) {
            ...
            debug(packet.name);
            result = DataSchema.parse(packet.schema, data, offset, referenceData).result;
