        ...
        fields: [
            { name: "id", type: "uint32", defaultValue: 0 },
            {
                ...
                fields: [
                    ...
                    { name: "change_mode_speed_percent", type: "float", defaultValue: 0.0 },
                    ...
                    { name: "camera_shake_change_speed", type: "float", defaultValue: 0.0 },
                    ...
                    { name: "dead_zone_influence_exponent", type: "float", defaultValue: 0.0 },
                    { name: "camera_shake_initial_intensity", type: "float", defaultValue: 0.0 },
                    ...
                    { name: "angular_dampening_scalar", type: "float", defaultValue: 0.0 },
...
var itemDetailSchema = [{ name: "unknownBoolean1", type: "boolean", defaultValue: false }];
var statDataSchema = [
                    ...
                    { name: "index", type: "uint32", defaultValue: 0 },
                    {
                        ...
                        fields: [
                            ...
                            { name: "flags", type: "uint8", defaultValue: 0 },
                            {
                                name: "attachments",
                                type: "array",
                                fields: [{ name: "attachmentId", type: "uint32", defaultValue: 0 }],
                            },
                            {
                                    ...
                                    fields: [
                                        {
                                            ...
                                            fields: [
                                                ...
                                                { name: "unknownBoolean1", type: "boolean", defaultValue: false },
                                                { name: "unknownString1", type: "string", defaultValue: "" },
                                                { name: "stationCurrencyId", type: "uint32", defaultValue: 0 },
                                                { name: "price", type: "uint32", defaultValue: 0 },
                                                { name: "currencyId", type: "uint32", defaultValue: 0 },
                                                { name: "currencyPrice", type: "uint32", defaultValue: 0 },
                                                { name: "unknownDword9", type: "uint32", defaultValue: 0 },
                                                { name: "unknownTime1", type: "uint64", defaultValue: "0" },
                                                { name: "unknownTime2", type: "uint64", defaultValue: "0" },
                                                { name: "unknownDword10", type: "uint32", defaultValue: 0 },
                                    ...
                                    fields: [
                                        ...
                                        { name: "imageSetId", type: "uint32", defaultValue: 0 },
                                        {
                                            ...
                                            fields: [
                                                ...
                                                { name: "nameId", type: "uint32", defaultValue: 0 },
                                                { name: "imageSetId", type: "uint32", defaultValue: 0 },
                                                { name: "itemCountMin", type: "uint32", defaultValue: 0 },
                                                { name: "itemCountMax", type: "uint32", defaultValue: 0 },
                                                { name: "itemType", type: "uint32", defaultValue: 0 },
                                            ],
                                        },
                                    ],
        ...
        0x8802,
        {
            fields: [
                ...
                },
                {
                    name: "unknownArray2",
                    type: "array",
                    fields: [{ name: "unknownQword1", type: "uint64", defaultValue: "0" }],
                },
                {
                    name: "unknownData1",
                    type: "schema",
