...
// ======================================================================
var EventEmitter = require("events").EventEmitter, GatewayClient = require("./gatewayclient").GatewayClient, fs = require("fs"), util = require("util"), ZoneProtocol = require("./zoneprotocol").ZoneProtocol, ZonePackets = require("./zoneprotocol").ZonePackets, debug = require("debug")("ZoneClient");
