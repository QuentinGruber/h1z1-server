...
var GatewayServer = /** @class */ (function (_super) {
    ...
    function GatewayServer(protocolName, serverPort, gatewayKey) {
        ...
        var soeServer = (_this._soeServer = new soeserver_1.SOEServer(protocolName, serverPort, gatewayKey, _this._compression, true)); // as any since SOEServer isn't typed
