"use strict";
var EventEmitter = require("events").EventEmitter, SOEServer = require("./soeserver").SOEServer, https = require("https"), fs = require("fs"), util = require("util"), GatewayProtocol = require("./gatewayprotocol").GatewayProtocol, debug = require("debug")("GatewayServer");
        ...
        if (packet != false && packet != undefined) {
            ...
            switch (packet.name) {
                case "LoginRequest":
                    ...
                    soeServer.sendAppData(client, protocol.pack("LoginReply", { loggedIn: true }), true);
                    soeServer.sendAppData(client, protocol.pack("ChannelIsRoutable", {
                        channel: 0,
                        isRoutable: true,
                    }), true);
                    soeServer.sendAppData(client, protocol.pack("ChannelIsRoutable", {
