...
var soeserver_1 = require("./soeserver");
var gatewayprotocol_1 = require("./gatewayprotocol");
...
var GatewayServer = /** @class */ (function (_super) {
    ...
    function GatewayServer(protocolName, serverPort, gatewayKey) {
        ...
        var soeServer = (_this._soeServer = new soeserver_1.SOEServer(protocolName, serverPort, gatewayKey, _this._compression)); // as any since SOEServer isn't typed
            ...
            if (packet !== false && packet !== undefined) {
                ...
                switch (packet.name) {
                    case "LoginRequest":
                        ...
                        if (result) {
                            _this.emit("login", null, client, result === null || result === void 0 ? void 0 : result.characterId);
                        }
                        break;
                    case "Logout":
                        debug("Logout");
