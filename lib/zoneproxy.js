...
function ZoneProxy(remoteAddress, remotePort, cryptoKey, localPort, localClientPort) {
    ...
    var gatewayProxy = this._gatewayProxy = new GatewayProxy(
        "ExternalGatewayApi_3", remoteAddress, remotePort, cryptoKey, localPort, localClientPort
    );
