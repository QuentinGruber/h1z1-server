...
var EventEmitter = require("events").EventEmitter, GatewayServer = require("./gatewayserver").GatewayServer, fs = require("fs"), path = require("path"), util = require("util"), packetHandlers = require("./zonepackethandlers.js"), ZoneProtocol = require("./h1z1protocol").H1Z1Protocol, debug = require("debug")("ZoneServer"), MongoClient = require("mongodb").MongoClient, MongoServer = require("mongodb").Server;
...
function ZoneServer(serverPort, gatewayKey, UsingMongo) {
    ...
    this.on("login", function (err, client) {
        if (err) {
            ...
            this.sendRawData(client, fs.readFileSync(__dirname + "/data/zone/ReferenceData.WeaponDefinitions.dat"));
            this.sendRawData(client, fs.readFileSync(__dirname + "/data/zone/InitializationParameters.dat"));
            ...
            this.sendRawData(client, fs.readFileSync(__dirname + "/data/zone/ClientUpdateZonePopulation.dat"));
            this.sendRawData(client, fs.readFileSync(__dirname + "/data/zone/ClientUpdateRespawnLocations.dat"));
            ...
            this.sendRawData(client, fs.readFileSync(__dirname + "/data/zone/Command.ItemDefinitions.dat"));
            //this.sendRawData(client, fs.readFileSync("./data/zone/VehicleBaseLoadVehicleDefinitionManager.dat"));
            this.sendRawData(client, fs.readFileSync(__dirname + "/data/zone/ReferenceData.VehicleDefinitions.dat"));
