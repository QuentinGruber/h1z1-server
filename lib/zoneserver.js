    ...
    this.on("login", function (err, client) {
        if (err) {
            ...
            this.sendRawData(
              ...
              */
            var itemData = fs.readFileSync(__dirname + "/data/ClientItemDefinitions.txt", "utf8"), itemLines = itemData.split("\n"), items = {};
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    _a._db = _b.sent();
                    return [3 /*break*/, 7];
                case 6: throw console.log("Unable to authenticate on mongo !", 2);
                case 7:
