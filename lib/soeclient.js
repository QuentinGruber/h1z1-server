...
function SOEClient(
  ...
  console.log(this._guid, "Creating new SOEClient instance");
  ...
  function handlePacket(packet) {
    ...
    switch (soePacket.name) {
      case "SessionReply":
        console.log("Received session reply from server");
      ...
      case "Ping":
        ...
        break;
      case "NetStatusReply":
        console.log("Received net status reply from server");
        break;
      case "Data":
        console.log("Received data packet from server");
        inputStream.write(result.data, result.sequence, false);
        break;
      case "DataFragment":
        console.log("Received data fragment from server");
      ...
      case "Ack":
        ...
        break;
      case "FatalError":
        console.log("Received fatal error from server");
        break;
...
SOEClient.prototype.connect = function () {
  console.log(
    "Setting up connection for " + this._serverAddress + ":" + this._serverPort
  );
...
SOEClient.prototype.sendAppData = function (data, overrideEncryption) {
  console.log(this._guid, "Sending app data: " + data.length + " bytes");
  this._outQueue.unshift(data); // Maybe working
