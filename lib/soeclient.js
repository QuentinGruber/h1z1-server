"use strict";
var EventEmitter = require("events").EventEmitter, SOEInputStream = require("./soeinputstream").SOEInputStream, SOEOutputStream = require("./soeoutputstream").SOEOutputStream, SOEProtocol = require("./soeprotocol").SOEProtocol, SOEPackets = require("./soeprotocol").SOEPackets, util = require("util"), fs = require("fs"), dgram = require("dgram"), debug = require("debug")("SOEClient");
