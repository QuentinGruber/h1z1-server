...
var LoginServer = /** @class */ (function (_super) {
    ...
    function LoginServer(gameId, environment, usingMongo, serverPort, loginKey, SpamGlitch) {
        ...
        _this._soeServer = new SOEServer("LoginUdp_9", serverPort, _this._cryptoKey, null, SpamGlitch);
        ...
        _this._soeServer.on("appdata", function (err, client, data) { var data, data, data, data; return __awaiter(_this, void 0, void 0, function () {
            var packet, result, _a, falsified_data, servers, SinglePlayerCharacter, characters_info, characters_Login_info;
                    ...
                    case 7:
                        ...
                        if (usingMongo) {
                            ...
                            characters_Login_info = {
                                ...
                                status: 1,
                                unknown: 1,
                                payload: "serverAddress: 127.0.0.1:1117,serverTicket: 7y3Bh44sKWZCYZH,encryptionKey: this._cryptoKey,characterId: 0x03147cca2a860191,unknown1: 722776196,unknown2: 0,stationName: reside0cupboy,characterName: VanuLabsVS, unknown3: 0,",
                            };
                        }
