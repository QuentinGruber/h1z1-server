...
var SOEServer = require("./soeserver").SOEServer;
var loginprotocol_1 = require("./loginprotocol");
...
var LoginServer = /** @class */ (function (_super) {
    ...
    function LoginServer(gameId, environment, serverPort, loginKey, SoloMode) {
        ...
        _this._soeServer.on("appdata", function (err, client, data) { return __awaiter(_this, void 0, void 0, function () {
            var packet, result, data_1, _a, falsified_data, servers, SoloServer, i, characters_delete_info, WaitSuccess, CharactersInfo, SinglePlayerCharacter, characters, charactersLoginInfo, _b, serverId, characterId, serverAddress, TestData;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        packet = this._protocol.parse(data);
                        if (!(packet !== false)) return [3 /*break*/, 20];
                        ...
                        switch (_a) {
                            ...
                            case "CharacterSelectInfoRequest": return [3 /*break*/, 9];
                            case "CharacterLoginRequest": return [3 /*break*/, 13];
                            case "TunnelAppPacketClientToServer": return [3 /*break*/, 17];
                            case "Logout": return [3 /*break*/, 18];
                        }
                        return [3 /*break*/, 19];
                    case 1:
                        falsified_data = {
                    ...
                    case 2:
                        servers = void 0;
                        if (!!this._soloMode) return [3 /*break*/, 4];
                        return [4 /*yield*/, this._db.collection("servers").find().toArray()];
                    case 3:
                        servers = _c.sent();
                        return [3 /*break*/, 5];
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 19];
                    case 7: return [4 /*yield*/, this._db
                    ...
                    case 9:
                        ...
                        return [3 /*break*/, 12];
                    case 10: return [4 /*yield*/, this._db
                            .collection("characters")
                            .find()
                            .toArray()];
                    case 11:
                    ...
                    case 13:
                        ...
                        if (!!this._soloMode) return [3 /*break*/, 15];
