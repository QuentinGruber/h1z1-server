...
var LoginServer = /** @class */ (function (_super) {
    ...
    function LoginServer(gameId, environment, serverPort, loginKey, SoloMode) {
        ...
        _this._soeServer.on("appdata", function (err, client, data) { var data, data, data, data, data, data; return __awaiter(_this, void 0, void 0, function () {
            var packet, result, _a, falsified_data, servers, SoloServer, i, characters_delete_info, characters_info, SinglePlayerCharacter, characters, characters_Login_info, test_data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        packet = this._protocol.parse(data);
                        if (!(packet != false)) return [3 /*break*/, 14];
                        ...
                        switch (_a) {
                            ...
                            case "CharacterLoginRequest": return [3 /*break*/, 11];
                            case "TunnelAppPacketClientToServer": return [3 /*break*/, 12];
                        }
                        return [3 /*break*/, 13];
                    case 1:
                        falsified_data = {
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 10];
                    case 8: return [4 /*yield*/, this._db
