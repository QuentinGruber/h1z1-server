...
var SOEServer = require("./soeserver").SOEServer, LoginProtocol = require("./loginprotocol").LoginProtocol, debug = require("debug")("LoginServer"), MongoClient = require("mongodb").MongoClient, PackageSetting = require("../package.json");
var LoginServer = /** @class */ (function (_super) {
    ...
    function LoginServer(gameId, environment, usingMongo, serverPort, loginKey) {
        ...
        _this._soeServer.on("appdata", function (err, client, data) { var data, data, data, data, data, data; return __awaiter(_this, void 0, void 0, function () {
            var packet, result, _a, falsified_data, servers, i, characters_delete_info, SinglePlayerCharacter, characters_info, characters_Login_info, falsified_data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 9:
                        ...
                        data = this._protocol.pack("TunnelAppPacketServerToClient", falsified_data);
                        this._soeServer.sendAppData(client, data, true);
                        return [3 /*break*/, 10];
