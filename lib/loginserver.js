...
var LoginServer = /** @class */ (function (_super) {
    ...
    function LoginServer(gameId, environment, usingMongo, serverPort, loginKey, SoloMode, ServerList) {
        ...
        if (SoloMode) {
            ...
            debug("You must provide a serverlist with Mongodb or with the serverlist argument !");
        ...
        _this._soeServer.on("appdata", function (err, client, data) { var data, data, data, data, data, data; return __awaiter(_this, void 0, void 0, function () {
            var packet, result, _a, falsified_data, servers, SoloServer, i, characters_delete_info, characters_info, SinglePlayerCharacter, characters_Login_info, falsified_data;
