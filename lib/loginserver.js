...
var LoginServer = /** @class */ (function (_super) {
    ...
    function LoginServer(gameId, environment, usingMongo, serverPort, loginKey, SpamGlitch) {
        ...
        _this._soeServer.on("appdata", function (err, client, data) { var data, data, data; return __awaiter(_this, void 0, void 0, function () {
            var packet, result, _a, falsified_data, servers, info;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        data = this._protocol.pack("CharacterSelectInfoReply", info);
