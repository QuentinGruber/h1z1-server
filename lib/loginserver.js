    ...
    function LoginServer(gameId, environment, usingMongo, serverPort, loginKey) {
        ...
        _this._soeServer.on("Force_sendServerList", function (err, client) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._db.collection("servers").find().toArray()];
                    case 1:
                        servers = _a.sent();
                        // remove object id
        ...
        _this._soeServer.on("appdata", function (err, client, data) { var data, data; return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        this._soeServer.sendAppData(client, data, true);
                        return [3 /*break*/, 6];
                    case 2: return [4 /*yield*/, this._db
                            .collection("servers")
                            .find()
                            .toArray()];
                    case 3:
