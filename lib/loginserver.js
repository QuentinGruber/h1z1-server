...
var LoginServer = /** @class */ (function () {
    ...
    LoginServer.prototype.connect = function (client) {
        debug("Client connected from " + client.address + ":" + client.port);
        //server.emit('connect', err, client);
    };
    LoginServer.prototype.disconnect = function (client) {
        debug("Client disconnected from " + client.address + ":" + client.port);
        //server.emit('disconnect', err, client);
    };
    LoginServer.prototype.session = function (client) {
        debug("Session started for client " + client.address + ":" + client.port);
    };
    LoginServer.prototype.Force_sendServerList = function (client) {
    ...
    LoginServer.prototype.SendServerUpdate = function (client) {
        return __awaiter(this, void 0, void 0, function () {
            var servers, i, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    LoginServer.prototype.appdata = function (client, data) {
        var data, data;
        return __awaiter(this, void 0, void 0, function () {
