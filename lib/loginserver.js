...
var LoginServer = /** @class */ (function (_super) {
    ...
    function LoginServer(gameId, environment, usingMongo, serverPort, loginKey) {
        ...
        _this._soeServer.on("appdata", function (err, client, data) { var data, data, data, data, data; return __awaiter(_this, void 0, void 0, function () {
            var packet, result, _a, falsified_data, servers, i, SinglePlayerCharacter, characters_info, characters_Login_info, falsified_data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        packet = this._protocol.parse(data);
                        if (!(packet != false)) return [3 /*break*/, 10];
                        ...
                        switch (_a) {
                            ...
                            case "TunnelAppPacketClientToServer": return [3 /*break*/, 8];
                        }
                        return [3 /*break*/, 9];
                    case 1:
                        falsified_data = {
