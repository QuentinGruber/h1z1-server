...
var LoginServer = /** @class */ (function (_super) {
    ...
    function LoginServer(gameId, environment, serverPort, loginKey, SoloMode) {
        ...
        _this._soeServer.on("appdata", function (err, client, data) { return __awaiter(_this, void 0, void 0, function () {
            var packet, result, data_1, _a, falsified_data, servers, SoloServer, i, characters_delete_info, WaitSuccess, characters_info, SinglePlayerCharacter, characters, charactersLoginInfo, TestData;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        switch (_a) {
                            ...
                            case "TunnelAppPacketClientToServer": return [3 /*break*/, 14];
                        }
                        return [3 /*break*/, 15];
                    case 1:
                        falsified_data = {
                    ...
                    case 11:
                        ...
                        _b.label = 12;
                    case 12:
                        data_1 = this._protocol.pack("CharacterSelectInfoReply", characters_info);
                        this._soeServer.sendAppData(client, data_1, true);
