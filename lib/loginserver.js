...
var LoginServer = /** @class */ (function (_super) {
    ...
    function LoginServer(gameId, environment, usingMongo, serverPort, loginKey) {
        ...
        _this._soeServer = new SOEServer("LoginUdp_9", serverPort, loginKey);
        _this._protocol = new LoginProtocol();
        _this.on("connect", function (client) {
            debug("Client connected from " + client.address + ":" + client.port);
            //server.emit('connect', err, client);
        });
        _this.on("disconnect", function (client) {
            debug("Client disconnected from " + client.address + ":" + client.port);
            //server.emit('disconnect', err, client);
        });
        _this.on("session", function (client) {
            debug("Session started for client " + client.address + ":" + client.port);
        });
        _this.on("Force_sendServerList", function (client) { return __awaiter(_this, void 0, void 0, function () {
            var servers, i, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._soeServer._db
                            .collection("servers")
                            .find()
        ...
        _this.on("SendServerUpdate", function (client) { return __awaiter(_this, void 0, void 0, function () {
            var servers, i, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._soeServer._db
        ...
        _this.on("appdata", function (client, data) { var data, data; return __awaiter(_this, void 0, void 0, function () {
            var packet, result, _a, falsified_data, servers;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        packet = this._protocol.parse(data);
                        if (!(packet != false)) return [3 /*break*/, 7];
                        result = packet.result;
                        _a = packet.name;
                        switch (_a) {
                            case "LoginRequest": return [3 /*break*/, 1];
                            case "ServerListRequest": return [3 /*break*/, 2];
                            case "CharacterSelectInfoRequest": return [3 /*break*/, 4];
                            case "CharacterLoginRequest": return [3 /*break*/, 5];
                        }
                        return [3 /*break*/, 6];
                    case 1:
                        falsified_data = {
                        ...
                        this._soeServer.sendAppData(client, data, true);
                        return [3 /*break*/, 6];
                    case 2: return [4 /*yield*/, this._soeServer._db
                            .collection("servers")
                            .find()
                            .toArray(function (err, servers) {
                            return servers;
