        ...
        fields: [
            ...
            { name: "characters",                   type: "array", fields: [
                ...
                { name: "payload",                      type: "byteswithlength", fields: [
                    ...
                    { name: "loadoutData",                  type: "schema", fields: [
                    ...
                    { name: "itemDefinitions",              type: "array", fields: [
                        { name: "itemId",                       type: "uint32" },
                        { name: "itemDefinitionData",           type: "schema", fields: [
                            { name: "itemId",                       type: "uint32" },
                    ...
                    { name: "attachmentDefinitions",        type: "array", fields: [
                        { name: "attachmentId",                 type: "uint32" },
                        { name: "attachmentData",               type: "schema", fields: [
                            { name: "attachmentId",             type: "uint32" },
