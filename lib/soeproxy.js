#!/usr/bin/env node
"use strict";
var EventEmitter = require("events").EventEmitter, SOEServer = require("./soeserver").SOEServer, SOEClient = require("./soeclient").SOEClient, util = require("util"), fs = require("fs"), debug = require("debug")("SOEProxy");
