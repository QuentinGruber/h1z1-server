...
// ======================================================================
var debug = require("debug")("ZoneProtocol"), DataSchema = require("h1z1-dataschema"), fs = require("fs"), ZonePackets = require("../../packets/archived/zonepackets");
...
ZoneProtocol.prototype.pack = function (packetName, object, referenceData) {
    var packetType = ZonePackets.PacketTypes[packetName], packet = ZonePackets.Packets[packetType], packetData, data, packetTypeBytes = [];
    if (packet) {
        while (packetType) {
        ...
        if (packet.schema) {
            packetData = DataSchema.pack(packet.schema, object, null, null, referenceData);
            if (packetData) {
...
ZoneProtocol.prototype.parse = function (data, flags, fromClient, referenceData) {
