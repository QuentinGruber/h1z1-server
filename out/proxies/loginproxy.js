...
// ======================================================================
var EventEmitter = require("events").EventEmitter, SOEProxy = require("./soeproxy").SOEProxy, LoginProtocol = require("../protocols/loginprotocol").LoginProtocol, fs = require("fs"), util = require("util"), debug = require("debug")("LoginProxy");
