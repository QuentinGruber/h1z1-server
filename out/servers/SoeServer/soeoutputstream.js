...
// ======================================================================
var EventEmitter = require("events").EventEmitter, crypto = require("crypto"), util = require("util"), debug = require("debug")("SOEOutputStream");
...
SOEOutputStream.prototype.write = function (data, overrideEncryption) {
    ...
    if (data.length <= this._fragmentSize) {
        ...
        var header = new Buffer.alloc(4), fragments = [];
