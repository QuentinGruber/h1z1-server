...
var LoginServer = /** @class */ (function (_super) {
  ...
  function LoginServer(serverPort, mongoAddress) {
    ...
    _this._soeServer = new SOEServer(
      "LoginUdp_9",
      serverPort,
      _this._cryptoKey,
      null
    ...
    _this._soeServer.on("SendServerUpdate", function (err, client) {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              ...
              return [
                4 /*yield*/,
                this._db.collection("servers").find().toArray(),
              ];
            case 1:
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 3:
              return [
                4 /*yield*/,
                this._db.collection("characters").find().toArray(),
              ];
            case 4:
              characters = _c.sent();
              CharactersInfo = {
            ...
            case 14:
              ...
              (_b = packet.result),
                (serverId = _b.serverId),
                (characterId = _b.characterId);
              if (!!this._soloMode) return [3 /*break*/, 16];
              return [
                4 /*yield*/,
                this._db.collection("servers").findOne({ serverId: serverId }),
              ];
            case 15:
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            mongoClient = this._mongoClient = new mongodb_1.MongoClient(
              this._mongoAddress,
              {
