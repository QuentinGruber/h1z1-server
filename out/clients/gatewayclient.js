...
// ======================================================================
var EventEmitter = require("events").EventEmitter, SOEClient = require("./soeclient").SOEClient, fs = require("fs"), util = require("util"), GatewayProtocol = require("../protocols/gatewayprotocol").GatewayProtocol, GatewayPackets = require("../protocols/gatewayprotocol").GatewayPackets, debug = require("debug")("GatewayClient");
...
function GatewayClient(serverAddress, serverPort, key, localPort) {
    ...
    var soeClient = (this._soeClient = new SOEClient("ExternalGatewayApi_3", serverAddress, serverPort, key, localPort));
...
GatewayClient.prototype.login = function (characterId, ticket, clientProtocol, clientBuild) {
