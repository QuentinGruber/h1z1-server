...
export declare enum ItemUseOptions {
    EAT = 1,
    DRINK = 2,
    USE = 3,
    DROP = 4,
...
export declare enum ConstructionErrors {
    UNKNOWN = "Unknown",
...
export declare enum ConstructionPermissionIds {
    BUILD = 1,
    DEMOLISH = 2,
    CONTAINERS = 3,
    VISIT = 4
}
export declare enum StringIds {
    TAKE_ITEM = 29,
    OPEN = 31,
    SEARCH = 1191,
    OPEN_AND_LOCK = 8944,
...
export declare enum MovementModifiers {
    RESTED = 1.1,
    SWIZZLE = 1.1,
    SNARED = 0.5,
    BOOTS = 1.15
...
export declare enum VehicleIds {
    OFFROADER = 1,
    PICKUP = 2,
    POLICECAR = 3,
    ATV = 5,
...
export declare enum LoadoutIds {
    CHARACTER = 3,
    VEHICLE_OFFROADER = 4,
    VEHICLE_PICKUP = 6,
    VEHICLE_POLICECAR = 8,
...
export declare enum LoadoutSlots {
    PRIMARY = 1,
    SECONDARY = 3,
    TERTIARY = 4,
    FISTS = 7,
...
export declare enum EquipSlots {
    HEAD = 1,
    HANDS = 2,
    CHEST = 3,
    LEGS = 4,
...
export declare enum EntityTypes {
    ...
    LOOTABLE_CONSTRUCTION = 10,
    LOOTABLE_PROP = 11,
    WORLD_LOOTABLE_CONSTRUCTION = 12,
    WORLD_CONSTRUCTION_SIMPLE = 13,
    PLANT = 14,
    TRAP = 15,
    TASK_PROP = 16,
    CRATE = 17,
...
export declare enum ResourceIds {
    HEALTH = 1,
    HUNGER = 4,
    HYDRATION = 5,
    STAMINA = 6,
...
export declare enum Items {
    ...
    CONTAINER_DRUG_CABINET = 5031,
    CONTAINER_MEDICAL_STATION = 5032,
    CONTAINER_HOSPITAL_DESK = 5033,
    CONTAINER_GROSSING_STATION = 5034,
    CONTAINER_HOSPITAL_REFRIGERATOR = 5035,
    CONTAINER_HOSPITAL_CABINET = 5036
}
export declare enum Skins_Shirt {
...
export declare enum Skins_Pants {
...
export declare enum Skins_Beanie {
    AVIATOR_CAP = 2058,
    BLACK_BEANIE = 2162,
    POLICE_HAT = 2344
}
export declare enum Skins_Cap {
    CAMO_GREEN_OUTBACK_HAT = 2046,
    TAN_CANVAS_OUTBACK_HAT = 2066,
    BROWN_LEATHER_OUTBACK_HAT = 2067,
    HAT_CAP = 12
}
export declare enum Skins_MotorHelmet {
    GORILLA_WARFARE = 3631,
    ARACHNID = 3721,
    DEFAULT = 2170
}
export declare enum Skins_Kevlar {
    KEVLAR_DEFAULT = 2271
}
export declare enum Skins_Military {
    Military_Default = 2124,
    Rasta_Backpack = 2393
}
export declare enum Skins_Glasses {
