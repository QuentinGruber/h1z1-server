START npx pkg --compress GZip -t node16-win-x64 ./2015/loginServer.js --output ./loginServer.exe
...
START npx pkg --compress GZip -t node16-win-x64 ./2016/loginServer.js --output ./loginServer-2016.exe
