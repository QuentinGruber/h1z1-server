pkg -t node16-win-x64 --compress GZip ./bin/2015/loginServer.js --output ./bin/loginServer.exe
...
pkg -t node16-win-x64 --compress GZip ./bin/2016/loginServer.js --output ./bin/loginServer-2016.exe
